...
---
```
git cherry-pick <start_commit>..<end_commit> :- It excludes the start commit while cherry-pick process of commits.
git cherry-pick <start_commit>^..<end_commit> :- We use this command to include the starting commit in the process
                                                  of cherry-pick of commits
```
