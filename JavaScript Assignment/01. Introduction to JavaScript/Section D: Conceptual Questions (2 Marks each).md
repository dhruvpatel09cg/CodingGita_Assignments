Q14. Differentiate between a static website and a dynamic website. Give one real-world example of each.
        ...
        facilities of interaction and changing pages or adding animation. e.g.: Personal Portfolios, 
        Wikipedia

        Dynamic website: Interactive websites on which you may use various functions and change pages 
        as needed. They also facilitate to take input and give output accordingly. e.g.: Amazon, 
        Google Maps

Q15. Explain any two features of JavaScript that make it suitable for creating interactive web pages.

        1. Event Driven: JS can respond to events caused by the user on webpage like click, keydown, submit,
        load etc. 2. Data Storage: JS can store previously entered data in database and can access it using
        server for acting according to response of user.
...
Q18. Explain the difference between Frontend and Backend using the restaurant analogy in your own words.
        ...
        Frontend is the menu which customer(user) sees on table he select option(Uses function) and orders,
        waiter and chef are part of Backend, waiter(server) tells his selection to chef(Database) and chef
        generates output user needed.

Q19. Why should a beginner learn JavaScript? Write at least 4 points.

        1. It makes websites interactive.
        2. It is useful for frontend as well as backend development.
        3. It can be used for mobile and desktop applications.
        4. It can run in browsers and on servers.
